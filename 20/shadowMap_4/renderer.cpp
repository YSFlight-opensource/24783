...
/* virtual */ void Phong3dRenderer::CacheAttributeAndUniformIdent(void)
{
	Gouraud3dRenderer::CacheAttributeAndUniformIdent();

	uniformShadowMapTexturePos=glGetUniformLocation(programIdent,"shadowMapTexture");
	printf("uniformShadowMapTexturePos=%d\n",uniformShadowMapTexturePos);
	uniformShadowMapTfmPos=glGetUniformLocation(programIdent,"shadowMapTfm");
	printf("uniformShadowMapTfmPos=%d\n",uniformShadowMapTfmPos);
}


////////////////////////////////////////////////////////////

/* virtual */ void DepthVerifyRenderer::CacheAttributeAndUniformIdent(void)
{
	attribVertexPos=glGetAttribLocation(programIdent,"vertex");
	attribTexCoordPos=glGetAttribLocation(programIdent,"texCoord");
	uniformTexturePos=glGetUniformLocation(programIdent,"texture");
}
