...
/* virtual */ void FsLazyWindowApplication::Draw(void)
{
	...
	glUseProgram(rainbow3d.programIdent);
	glUniformMatrix4fv(rainbow3d.uniformProjectionPos,1,GL_FALSE,projMat);
	glUniformMatrix4fv(rainbow3d.uniformModelViewPos,1,GL_FALSE,viewMat);

	glEnableVertexAttribArray(rainbow3d.attribVertexPos);
	glVertexAttribPointer(rainbow3d.attribVertexPos,3,GL_FLOAT,GL_FALSE,0,vtx.data());

	glDrawArrays(GL_TRIANGLES,0,vtx.size()/3);

	glDisableVertexAttribArray(rainbow3d.attribVertexPos);
